...
class BioService(rpyc.Service):
    ...
    def exposed_sortNivExprDict(self):
        self.sortedNivExprListIndice = 0
        self.sortedNivExprList = sortDictByValue(self.nivExprDict)

    def exposed_sortedNivExprListIndiceAddOne(self):
        self.sortedNivExprListIndice += 1

    def exposed_getNivExprByIndice(self, indice):
        return self.sortedNivExprList[indice]
